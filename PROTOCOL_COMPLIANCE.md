...
| Claim | Test | Outcome |
|---|---|---|
| Pareto safety | LexUR never selects a dominated alternative | **0/150 violations** |
...
| Stochastic | confidence-aware LexUR lowers out-of-sample tail risk | **✓** risk ≈0 vs TOPSIS 0.20 / SMAA 0.57 |
| Multi-stakeholder | Rawlsian LexUR lowers worst-stakeholder regret/inequality | **✓** worst 0.362 & Gini 0.207 (lowest) |

## 2. Benchmark suite (broadened per protocol)

- **Methods (11):** TOPSIS, CP, VIKOR, Knee, hypervolume (HV),
  random-weights, ASF, SMAA, MMR (linear minimax regret), Chebyshev-MMR, **LexUR**.
...
HV 4.27, ASF 4.65, MMR 4.65, **LexUR 4.67**, VIKOR 4.71, ChebMMR 4.99, CP 5.32,
TOPSIS 6.98, Knee 7.21, RW 9.26, SMAA 9.30. LexUR is **within CD of the best
...
Honest reading: LexUR is **practically equivalent** to the strongest robust
...
| Redundancy < averaging (grouped) | **PASS** | LexUR 0.256 vs averaging 0.359 |
| Adaptive ≈ full (tail gap ≤ 0.01) | **PASS** | gap +0.0053 |
| Direct computation (LP + MILP) | **PASS** | LP: 19 vs 150 solver calls; MILP: 4 vs 60 calls |
| Stochastic LexUR ≤ deterministic (tail) | **PASS** | risk 0.383 vs 0.383 |
...
LexUR; Cliff's δ effect size; bootstrap 95% CIs for paired mean differences;
...
> LexUR is not universally best. It is a robust, certifiable selection rule:
