...
family stays $O(m+c)$, giving a nearly four-thousand-fold reduction by $m=15$ with
little loss of decision quality (\S\ref{sec:exp}).}
\label{fig:reduction}
\end{figure}
