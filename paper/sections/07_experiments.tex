...
LUR is insensitive to the clustering threshold $\theta$ over $[0.3,0.9]$ across all four geometries. Under nadir-estimation error the held-out loss of the chosen alternative stays stable ($\approx 0.45$ up to $30\%$ error), though the identity of the choice changes increasingly often. Table~\ref{tab:sens} quantifies these diagnostics: near-ties among good alternatives cause the choice identity to flip, but decision quality remains fully protected.
